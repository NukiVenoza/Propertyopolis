...
// IMAGE UPLOAD
// IMAGE PROPERTI
const imageUpload = document.querySelector("#photoProperty");
var uploadedImage = "";
...
// IMAGE DENAH
const imageUpload2 = document.querySelector("#photoDenah");
var uploadedImage2 = "";

imageUpload2.addEventListener('change', function(){
    const readFile = new FileReader();
    readFile.addEventListener('load', () => {
        uploadedImage2 = readFile.result;
        document.querySelector('.display-image2').style.backgroundImage = `url(${uploadedImage2})`;
    })
    readFile.readAsDataURL(this.files[0]);
})
